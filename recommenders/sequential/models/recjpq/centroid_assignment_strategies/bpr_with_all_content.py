...
class BPRWithAllContentAssignmentStrategy(CentroidAssignmentStragety):
    ...
    def assign(self, train_users):
        ...
        model = LightFM(no_components=self.item_code_bytes *3 // 8, loss='bpr')
        ...
        k = self.item_code_bytes - int(self.item_code_bytes *3// 8)
